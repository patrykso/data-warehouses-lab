...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\teachers.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\students.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
BULK INSERT courses
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\courses.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\subjects.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\courses_subjects.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
BULK INSERT lessons
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\lessons.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\enrollments.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\lesson_ratings.csv'
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T2\attendance.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
