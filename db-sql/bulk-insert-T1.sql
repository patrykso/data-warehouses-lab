...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\teachers.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\students.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
BULK INSERT courses
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\courses.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\subjects.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\courses_subjects.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
BULK INSERT lessons
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\lessons.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\enrollments.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\lesson_ratings.csv'
...
FROM 'C:\Users\jozef\source\PG-HD-LAB2-DATA-GENERATOR\tsql\T1\attendance.csv'
WITH (
    FORMAT='CSV',
    FIELDQUOTE='"',
    FIELDTERMINATOR = ',',
